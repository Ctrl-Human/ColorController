...
Shader "Vefects/SH_Vefects_HDRP_Galaxy"
{
	Properties
	{
		...
		_HDRPEmissionCompensation("HDRP Emission Compensation", Float) = 10000
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _HDRPEmissionCompensation;
						...
						)
			{
				...
				float3 ase_worldReflection = reflect(-ase_viewDirWS, normalWS);
				...
				float expo101 = _HDRPEmissionCompensation;
				float3 temp_output_4_0 = ( ( saturate( hsvTorgb8_g1 ) * _GalaxyTint.rgb ) * ( expo101 * _GalaxyEmissionIntensity ) );
				
				float fresnelNdotV8 = dot( normalWS, ase_viewDirWS );
				...
				float2 uv_StarsTexture = packedInput.ase_texcoord5.xyz.xy * _StarsTexture_ST.xy + _StarsTexture_ST.zw;
				float2 panner65 = ( 1.0 * _Time.y * _StarsSpeed + ( ( uv_StarsTexture * _StarsTile ) * _StarsTileOverall ));
				float2 uv_StarsNoiseTexture = packedInput.ase_texcoord5.xyz.xy * _StarsNoiseTexture_ST.xy + _StarsNoiseTexture_ST.zw;
				...
				surfaceDescription.BaseColor = ( temp_output_4_0 * _GalaxyBaseColorIntensity );
				...
				surfaceDescription.Emission = ( ( saturate( hsvTorgb8_g2 ) * ( expo101 * _FresnelEmissionIntensity ) ) + ( temp_output_4_0 + ( saturate( hsvTorgb8_g3 ) * ( expo101 * _StarsEmissionIntensity ) ) ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = inputMesh.uv0.xyz;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 hsvTorgb4_g2 = RGBToHSV( ( _FresnelColor * saturate( staticSwitch62 ) ).rgb );
				float3 hsvTorgb8_g2 = HSVToRGB( float3(( hsvTorgb4_g2.x + _FresnelHueShift ),( hsvTorgb4_g2.y + 0.0 ),( hsvTorgb4_g2.z + 0.0 )) );
				float2 uv_StarsTexture = packedInput.ase_texcoord4.xyz.xy * _StarsTexture_ST.xy + _StarsTexture_ST.zw;
				float2 panner65 = ( 1.0 * _Time.y * _StarsSpeed + ( ( uv_StarsTexture * _StarsTile ) * _StarsTileOverall ));
				float2 uv_StarsNoiseTexture = packedInput.ase_texcoord4.xyz.xy * _StarsNoiseTexture_ST.xy + _StarsNoiseTexture_ST.zw;
				float2 panner68 = ( 1.0 * _Time.y * _StarsNoiseSpeed + ( ( uv_StarsNoiseTexture * _StarsNoiseTile ) * _StarsNoiseTileOverall ));
				float4 tex2DNode32 = tex2D( _StarsNoiseTexture, panner68 );
				float4 tex2DNode28 = tex2D( _StarsTexture, ( panner65 + ( _StarsDistortion * tex2DNode32.g ) ) );
				float4 lerpResult26 = lerp( _StarsColor01 , _StarsColor02 , saturate( ( ( tex2DNode28.g * tex2DNode32.g ) * 30.0 ) ));
		...
		Pass
		{
						...
						)
			{
				...
				float3 hsvTorgb4_g2 = RGBToHSV( ( _FresnelColor * saturate( staticSwitch62 ) ).rgb );
				float3 hsvTorgb8_g2 = HSVToRGB( float3(( hsvTorgb4_g2.x + _FresnelHueShift ),( hsvTorgb4_g2.y + 0.0 ),( hsvTorgb4_g2.z + 0.0 )) );
				float2 uv_StarsTexture = packedInput.ase_texcoord7.xyz.xy * _StarsTexture_ST.xy + _StarsTexture_ST.zw;
				float2 panner65 = ( 1.0 * _Time.y * _StarsSpeed + ( ( uv_StarsTexture * _StarsTile ) * _StarsTileOverall ));
				float2 uv_StarsNoiseTexture = packedInput.ase_texcoord7.xyz.xy * _StarsNoiseTexture_ST.xy + _StarsNoiseTexture_ST.zw;
				float2 panner68 = ( 1.0 * _Time.y * _StarsNoiseSpeed + ( ( uv_StarsNoiseTexture * _StarsNoiseTile ) * _StarsNoiseTileOverall ));
				float4 tex2DNode32 = tex2D( _StarsNoiseTexture, panner68 );
				float4 tex2DNode28 = tex2D( _StarsTexture, ( panner65 + ( _StarsDistortion * tex2DNode32.g ) ) );
				float4 lerpResult26 = lerp( _StarsColor01 , _StarsColor02 , saturate( ( ( tex2DNode28.g * tex2DNode32.g ) * 30.0 ) ));
...
WireConnection;4;1;104;0
WireConnection;10;0;83;0
WireConnection;10;1;100;0
...
WireConnection;100;1;11;0
WireConnection;104;0;105;0
WireConnection;104;1;5;0
WireConnection;106;0;107;0
WireConnection;106;1;25;0
WireConnection;89;0;49;0
WireConnection;89;4;44;0
WireConnection;89;6;9;0
WireConnection;89;7;45;0
ASEEND*/
//CHKSM=A8A6155CB5D08ECE2ED54727972ED92594C2D617